		...
		switch (contexto.getEvento()){
			...
			case ListaComandos.MOSTRAR_ALTA_VIDEOJUEGO:
				...
				switch((int)contexto.getDatos()){				
					case -2:
						msgAlta = "Videojuego no activa, se ha vuelto a activar";
						break;
					case -1:
						msgAlta = "Videojuego no guardada, debido a que ya existe una bicicleta con esa marca";
						break;
					case 0:
						msgAlta = "Videojuego no guardada, debido a un error con la Base de Datos";
						break;
					default:
			...
			case ListaComandos.MOSTRAR_MODIFICAR_VIDEOJUEGO:
				...
				switch((int)contexto.getDatos()){
					case -4:
						...
						break;
					case -3:
						msgModificar = "Videojuego no modificado, debido a que la marca introducida ya existe en la base de datos";
						break;
					case -2:
