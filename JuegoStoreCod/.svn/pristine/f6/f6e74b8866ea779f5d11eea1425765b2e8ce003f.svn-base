...
public class JFrameDevolucionCompra extends JFrame{
	...
	public class ActionListenerDevolucionCompra implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0){
			try{
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_DEVOLUCION_COMPRA, new TransferLineaDeCompra(Integer.parseInt(idCompra.getText()), Integer.parseInt(idArticulo.getText()), Integer.parseInt(cantidadArticulo.getText())));
			}
