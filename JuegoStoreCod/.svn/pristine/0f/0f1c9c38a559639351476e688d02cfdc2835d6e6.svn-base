...
public class JFrameModificarCliente extends JFrame{
	...
	public JFrameModificarCliente(){
		this.setTitle("Modificar cliente carretera");
	...
	public class ActionListenerModificarCliente implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0){
			try{
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_MODIFICAR_CLIENTE, new TransferCliente(Integer.parseInt(id.getText()), nombre.getText(), tarjetaDeCredito.getText(), true));
			}
